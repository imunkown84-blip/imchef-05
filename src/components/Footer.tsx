        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Premium quality noodles and authentic sauces delivered fresh to your door. 
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/shop?category=noodles" className="text-muted-foreground hover:text-primary transition-colors text-sm">
                  Noodles
                </Link>
              </li>
              <li>
                <Link to="/shop?category=sauces" className="text-muted-foreground hover:text-primary transition-colors text-sm">
                  Sauces
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-muted-foreground text-sm">hello@spiceandnoodle.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="w-4 h-4 text-primary" />
                <span className="text-muted-foreground text-sm">123 Food Street, Culinary City, CC 12345</span>
              </div>
            </div>
          </div>
        </div>
